                        ...
                        value: function () {
                            ...
                            if ("scroll-handle" === this.targetModifier) {
                                ...
                                var s = t.height - parseFloat(i.borderTopWidth) - parseFloat(i.borderBottomWidth) - r,
                                    ...
                                    f = 0;
                                s < 408 && this.target === document.body && (f = -11e-5 * Math.pow(s, 2) - 0.00727 * s + 22.58), this.target !== document.body && (e.height = Math.max(e.height, 24));
        ...
        position: function (t) {
            ...
            return (
                this.options.constraints.forEach(function (t) {
                    ...
                    var b = O(e, r);
                    ("target" !== d && "both" !== d) || (o < b[1] && "top" === v.top && ((o += p), (v.top = "bottom")), o + s > b[3] && "bottom" === v.top && ((o -= p), (v.top = "top"))),
                        "together" === d &&
                            ("top" === v.top &&
                                ("bottom" === y.top && o < b[1] ? ((o += p), (v.top = "bottom"), (o += s), (y.top = "top")) : "top" === y.top && o + s > b[3] && o - (s - p) >= b[1] && ((o -= s - p), (v.top = "bottom"), (y.top = "bottom"))),
                            "bottom" === v.top &&
                                ("top" === y.top && o + s > b[3] ? ((o -= p), (v.top = "top"), (o -= s), (y.top = "bottom")) : "bottom" === y.top && o < b[1] && o + (2 * s - p) <= b[3] && ((o += s - p), (v.top = "top"), (y.top = "top"))),
                            "middle" === v.top && (o + s > b[3] && "top" === y.top ? ((o -= s), (y.top = "bottom")) : o < b[1] && "bottom" === y.top && ((o += s), (y.top = "top")))),
                        ("target" !== h && "both" !== h) || (i < b[0] && "left" === v.left && ((i += u), (v.left = "right")), i + f > b[2] && "right" === v.left && ((i -= u), (v.left = "left"))),
                        "together" === h &&
                            (i < b[0] && "left" === v.left
                                ? "right" === y.left
                                ...
                                : "center" === v.left && (i + f > b[2] && "left" === y.left ? ((i -= f), (y.left = "right")) : i < b[0] && "right" === y.left && ((i += f), (y.left = "left")))),
